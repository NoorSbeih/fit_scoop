...
class femaleGoalsUpdate extends StatefulWidget {
  final Function(String) onUpdateGoal;
  const femaleGoalsUpdate({Key? key,required this.onUpdateGoal}) : super(key: key);
  @override
  State<femaleGoalsUpdate> createState() => _RegisterPageState();
}

class _RegisterPageState extends State<femaleGoalsUpdate> {
  String selectedGoal = '';
  @override
  void initState() {
    super.initState();
