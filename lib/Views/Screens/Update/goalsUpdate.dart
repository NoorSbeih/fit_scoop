...
class goalsUpdate extends StatefulWidget {
  final Function(String) onUpdateGoal;

  goalsUpdate({Key? key, required this.onUpdateGoal}) : super(key: key);

  @override
  createState() => _goalsUpdateState();

}

class _goalsUpdateState extends State<goalsUpdate> {
   String selectedGoal = '';
  @override
  void initState() {
    super.initState();
