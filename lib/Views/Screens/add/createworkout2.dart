...
class _createWorkout2  extends State<createWorkout2> {
 ...
 TextEditingController descriptionController =new TextEditingController();
  ...
  Widget build(BuildContext context) {
   ...
   Workout workout =new Workout(name: createWorkout1.name, description: descriptionController.text, exercises: addExercise.exercises, duration: 12, intensity: label, creatorId: user.id, numberOfSaves: 0, reviews: [], isPrivate: isPrivate);
