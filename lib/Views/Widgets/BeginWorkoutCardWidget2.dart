...
import '../Screens/Workout/exercise_details_screen.dart';

class BeginWorkoutCardWidget2 extends StatelessWidget {
  final String name;
  final String sets;
  final String weight;
  final String id;
            ...
            children: [
              Container(
                ...
                child: imageUrl.isEmpty
                    ? Icon(Icons.photo) // Placeholder if no data
                    : Image.network(
                  imageUrl,
                  width: 148,
                  height: 128,
